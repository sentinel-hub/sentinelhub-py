## [Version 3.11.5] - 2026-03-04

### Documentation

- Added warning to `instance_type` parameter documentation for `BatchProcessClient.create()`. This parameter is for internal use only and is subject to change without notice.
