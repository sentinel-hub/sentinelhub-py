...
- When monitoring a batch job it now waits for the status of the job to change (even if all tiles have completed) before finalization in order to return the correct status.
