...
class BBox(_BaseGeometry):
    ...
    def __init__(self, bbox: Union[tuple, list, dict, shapely.geometry.base.BaseGeometry], crs: CRS):
        """
    ...
    @staticmethod
    def _to_tuple(
        bbox: Union[tuple, list, dict, shapely.geometry.base.BaseGeometry]
