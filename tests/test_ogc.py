    ...
    def setUpClass(cls):
        ...
        cls.test_cases = [
            ...
            cls.OgcTestCase('MODIS Test',
                            ...
                            result_len=1, img_min=0.0, img_max=3.2767, img_mean=0.2445, img_median=0.0030,
                            tile_num=1),
            cls.OgcTestCase('S1 IW Test',
                            ...
                            result_len=1, img_min=0.0, img_max=1.0,
                            img_mean=0.3508, img_median=0.07587, tile_num=2),
            ...
            cls.OgcTestCase('S1 EW SH Test',
                            WmsRequest(data_collection=DataCollection.SENTINEL1_EW_SH,
                                       ...
                                       time_difference=datetime.timedelta(hours=1)),
                            result_len=1, img_min=0.0072, img_max=1.0, img_mean=0.5071, img_median=0.5270,
                            tile_num=1),
            ...
            cls.OgcTestCase('S1 IW DES Test',
                            WmsRequest(data_collection=DataCollection.SENTINEL1_IW_DES, data_folder=cls.OUTPUT_FOLDER,
                                       ...
                                       time_difference=datetime.timedelta(hours=1)),
                            result_len=1, img_min=0.0, img_max=1.0,
                            img_mean=0.3474, img_median=0.04087, tile_num=1),
